# TODO move all functions into separate files
...
errors = {
    "program": (
        "Bad input, please refer this spec-\n"
...
def midi_number_to_note_and_octave(number: int) -> tuple:
...
def note_and_octave_to_midi_number(note: str, octave: int) -> int:
